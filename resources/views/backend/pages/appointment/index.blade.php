...
@section('content')
  ...
  <div class="page-header">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="{{route('backend.appointment.index')}}">appointment</a></li>
    </ol>
  </div>
  <!-- Page header end -->
  <!-- Main container start -->
  <div class="main-container">
    @include('backend.pages.appointment.components.all-report')
    <div class="row gutters">
      @include('backend.pages.notify.message')
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="table-container" id="statusa">
          <div class="table-responsive">
            <table id="print-table1" class="table custom-table @if (count($allAppointment)>0) css-serial @endif">
              <thead>
                <tr>
                  <th >SL:</th>
                  <th >Name</th>
              ...
              <tbody>
                @foreach($allAppointment as $key =>$value)
                  <tr>
                    <td></td>
