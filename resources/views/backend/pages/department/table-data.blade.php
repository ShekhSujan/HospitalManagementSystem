<div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
    ...
    <div class="table-container">
        <div class="t-header">All Departments</div>
        <div class="table-responsive">
            <form style="overflow: hidden;" action="{{route('backend.department.bulk_destroy')}}" method="post">
                @csrf
                        ...
                        <tr>
                            ...
                            <td>
                              ...
                              <div class="custom-control custom-switch">
                                ...
                                <a href="{{ route("backend.department.edit", $value->id) }}" title="Edit Row"><span class="btn btn-info btn-sm"><i class="icon-edit1"></i></span></a>
                              @endif
  ...
  @endif
            ...
            <!-- ################# Small modal ####################-->
            @include('backend.pages.department.delete-modal')
                @include('backend.pages.department.script')
            <!-- Main container end -->
        </div>
    </div>
</div>
