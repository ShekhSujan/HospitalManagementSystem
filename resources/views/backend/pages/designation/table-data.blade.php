<div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12 " id="">
  ...
  <div class="table-container" >
    <div class="t-header">All Designations</div>
    <div class="table-responsive" >
      <form style="overflow: hidden;" action="{{route('backend.designation.bulk_destroy')}}" method="post">
        @csrf
        <table id="print-table1" class="table custom-table @if (count($allDesignation)>0) css-serial @endif">
          <thead>
            <tr>
              ...
              <tr>
                ...
                <td>
                  ...
                  <div class="custom-control custom-switch">
                    ...
                    <a href="{{ route("backend.designation.edit", $value->id) }}" title="Edit Row"><span class="btn btn-info btn-sm"><i class="icon-edit1"></i></span></a>
                  @endif
...
@endif
        ...
        <!-- ################# Small modal ####################-->
        @include('backend.pages.designation.delete-modal')
        @include('backend.pages.designation.script')
        <!-- ################# Small modal ####################-->
      </div>
    </div>
  </div>
